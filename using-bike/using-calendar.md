...
Three commands let you work with the calendar from the command palette, or you can bind them to keyboard shortcuts in [Bike's keybindings](commands-explorer.md):
