...
Open **Bike > Logs Explorer** to view Bike's log output. It's mainly a tool for extension and theme development — when something goes wrong with an [extension](using-extensions.md) or a [theme](using-themes.md), this is where the details show up.
