...
OPML is another option for interchange. It's a [common standard](http://opml.org) for outlines with a long list of [compatible apps](http://opml.org/compatibleApps.opml), though it doesn't support all Bike features like row types and text formatting.
