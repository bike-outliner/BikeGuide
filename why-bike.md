...
Bike makes your work open and accessible. Outlines are stored in text files using standard file formats, including [Bike Markdown](using-bike/bikemd-format.md). Bike is also scriptable and extensible. Automate Bike with [scripts](using-bike/using-scripts.md), customize it with [themes](using-bike/using-themes.md), and add new features with [extensions](using-bike-advanced/installing-extensions.md).
