...
* _Extension_: A plugin that adds new features to Bike. See [Installing Extensions](using-bike-advanced/installing-extensions.md).
...
* _Row Type_: The semantic type of a row, such as heading, task, ordered list, etc. See [Row Types](using-bike/row-types.md).
